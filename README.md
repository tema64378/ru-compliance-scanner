...
требования по контексту. **Политику проверяет «по-взрослому»** — заходит по ссылке
и смотрит, открывается ли страница и есть ли обязательные блоки (цели обработки,
оператор, права субъекта). В конце считает **суммарный потенциальный штраф**.
